...
const RecordsTab = () => {
  return (
    <div className="space-y-6">
      ...
      <div id="academic-records" className="bg-white rounded-xl shadow-sm border border-gray-100">
        <div className="p-6 border-b border-gray-200">
          <h3 className="text-2xl font-bold text-gray-800">Academic Records</h3>
          <p className="text-sm text-gray-600 mt-1">Complete history of academic assessments and grades</p>
        </div>
        <div className="p-6">
      ...
      <div id="aptitude-tests" className="bg-white rounded-xl shadow-sm border border-gray-100">
        <div className="p-6 border-b border-gray-200">
          <h3 className="text-2xl font-bold text-gray-800">Aptitude Test History</h3>
          <p className="text-sm text-gray-600 mt-1">Monthly aptitude assessments and skill evaluations</p>
        </div>
        <div className="p-6">
      ...
      <div id="interview-records" className="bg-white rounded-xl shadow-sm border border-gray-100">
        <div className="p-6 border-b border-gray-200">
          <h3 className="text-2xl font-bold text-gray-800">Personal Interview Records</h3>
          <p className="text-sm text-gray-600 mt-1">Counselor sessions and personal development tracking</p>
        </div>
        <div className="p-6">
          <div className="space-y-4">
            {[
